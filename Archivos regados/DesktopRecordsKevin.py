...
def agregarPais():
    ...
    Paises = []
    xml_datamundo.append(newCoti)
    newCoti.set('name',f'{NuevoConti}')
    for continente in xml_datamundo:
        conti = continente.attrib['name']
        lst_paises = continente.findall('pais')
        for pais in lst_paises:
    ...
    #         nombre = ET.SubElement(paisnew, 'nombre')
    ...
    #         nombre.text = f'{NuevoNombre}'
    #         capital.text = f'{NuevoCapital}'
    #         idioma.text = f'{NuevoIdioma}'
    #         poblacion.text = f'{NuevoPoblacion}'
    #         paisesnuevos2 = """
    #         <continente name="""+ NuevoConti + """>
	# 	        <pais moneda="""+NuevoMoneda+""">
	# 		        <nombre>"""+NuevoNombre+"""</nombre>
	# 		        <capital>"""+NuevoCapital+"""</capital>
	# 		        <idioma>"""+NuevoIdioma+"""</idioma>
	# 		        <poblacion year="""+NuevoPobYear+""" unit="""+NuevoPobUnit+""">"""+NuevoPoblacion+"""</poblacion>
	# 	        </pais>
	#         </continente>
    #         """
    #mydata = str(ET.tostring(continentenew))
    # print(mydata)
    # actualizacion = open("Mundo2.xml", "a")
